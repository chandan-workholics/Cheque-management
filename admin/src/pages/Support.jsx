                                                                ...
                                                                <table class="table rounded-3">
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th scope="col" class="text-445B64">Ticket ID</th>
                                                                            <th scope="col" class="text-445B64">Subject</th>
                                                                            <th scope="col" class="text-445B64">Status</th>
                                                                            <th scope="col" class="text-445B64">Created</th>
                                                                            <th scope="col" class="text-445B64">Assigned To</th>
