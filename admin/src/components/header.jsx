                ...
                <div className="offcanvas-body">
                    <div className="sidebar d-flex flex-column py-3 px-1 w-100" style={{ paddingTop: '0px !important' }}>
                        <ul className="nav nav-pills flex-column mb-auto gap-2">
                            ...
                            <li>
                                <NavLink to="/cm-admin/all-cheques" className="nav-link">
                                    <div className="sidebar-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="16" viewBox="0 0 15 16" fill="none">
                                    ...
                                    <span className="">All Cheques</span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink to="/cm-admin/report" className="nav-link">
                                    <div className="sidebar-icon">
                        ...
                        <div className="position-relative">
                            <div className="position-absolute bottom-0 left-0 w-100" style={{ paddingRight: '7px' }}>
                                <div className="card sidebarSupport border-0" style={{ borderRadius: '24px' }}>
                                    <div className="card-body bg-transparent p-xxl-3">
                                        ...
                                        <NavLink to='/cm-admin/support' className="btn fs-13 fw-semibold border-0 py-2 text-00C7BE bg-white w-100" style={{ borderRadius: '12px' }}>
