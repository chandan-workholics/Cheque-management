                                                        ...
                                                        <div class="d-flex gap-5">
                                                            <div class="">
                                                                <h6 class="fs-14 mb-1">
                                                                    ...
                                                                    <span className="text-0D161A fw-semibold">Rohit Sharma</span>
                                                                </h6>
                                                                <h6 class="fs-14 mb-1">
                                                                    <span className="text-445B64 fw-normal">Mobile : </span>
                                                                    <span className="text-0D161A fw-semibold">+(1) 987 654354</span>
                                                                </h6>
                                                                <h6 class="fs-14 mb-1">
