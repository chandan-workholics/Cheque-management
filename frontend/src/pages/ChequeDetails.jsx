                                                        ...
                                                        <div class="col-12 col-lg-6">
                                                            <div class="d-flex justify-content-between mb-3 mb-lg-0">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <span class="text-445B64 fw-medium">Check Information</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="card-body">
                                                    <div className="d-flex justify-content-between">
                                                        <div class="d-flex gap-5">
                                                            <div class="mb-3">
                                                                <h6 class="text-445B64 fs-14 mb-1">Customer Name</h6>
                                                                <h6 class="text-0D161A fw-semibold fs-14">Rohit Sharma</h6>
                                                            </div>
                                                            <div class="mb-3">
                                                                <h6 class="text-445B64 fs-14 mb-1">License No</h6>
                                                                <h6 class="text-0D161A fw-semibold fs-14">464646556</h6>
                                                            </div>
                                                            <div class="mb-3">
                                                                <h6 class="text-445B64 fs-14 mb-1">Company</h6>
                                                                <h6 class="text-0D161A fw-semibold fs-14">State Bank Of India</h6>
                                                            </div>
                                                            <div class="mb-3">
                                                                <h6 class="text-445B64 fs-14 mb-1">Check Type</h6>
                                                                <h6 class="text-0D161A fw-semibold fs-14">Self</h6>
                                                            </div>
                                                            <div class="mb-3">
                                                                <h6 class="text-445B64 fs-14 mb-1">Amount</h6>
                                                                <h6 class="text-0D161A fw-semibold fs-14">50.0000</h6>
                                                            </div>
                                                            <div class="mb-3">
                                                                <h6 class="text-445B64 fs-14 mb-1">Date</h6>
                                                                <h6 class="text-0D161A fw-semibold fs-14">25/12/2025</h6>
                                                            </div>
                                                        </div>
                                                        <div class="d-flex gap-5">
                                                            <div class="mb-3">
                                                                <h6 class="text-445B64 fs-14 mb-1">Status</h6>
                                                                <div className="">
                                                                    <button class="btn btn-sm rounded-2 lh-1 bg-4FD1C5 text-white me-3">
                                                                        Active
                                                                    </button>
                                                                    <button class="btn btn-sm rounded-2 lh-1 bg-E84D4D text-white">
                                                                        Deactive
                                                                    </button>
                                                                </div>
                                                            </div>
