            ...
            <div className="sidebar d-flex flex-column py-3 px-1 d-none d-lg-block position-fixed">
                ...
                <div className="position-absolute bottom-0 left-0 w-100 mb-3" style={{paddingRight:'7px'}}>
                    <div className="card sidebarSupport border-0" style={{borderRadius:'24px'}}>
                        <div className="card-body bg-transparent p-xxl-4">
                            <img src={supportIconImg} alt="" className='mb-4' />
                            <h5 className="text-white fw-semibold">Need help?</h5>
                            <h6 className="text-white fw-normal mb-3">Please check our docs</h6>
                            <Link to='/cheque-management/support' className="btn fw-semibold border-0 py-2 text-00C7BE bg-white w-100" style={{borderRadius:'12px'}}>
