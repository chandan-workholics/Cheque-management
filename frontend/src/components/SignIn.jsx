                        ...
                        <div className="row h-100">
                            <div className="col-lg-6 mx-auto d-flex justify-content-center align-items-center">
                                <div className="w-100">
                                    ...
                                    <input className="form-control mb-2 rounded-3" type="password" placeholder="Your password" aria-label="example" />
                                    ...
                                    <Link to='/cheque-management/dashboard' className="btn w-100 sign-btn mb-3">Sign In</Link>
