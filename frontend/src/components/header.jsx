                    ...
                    <ul className="navbar-nav ms-auto mb-lg-0 d-flex flex-row">
                        ...
                        <li className="nav-item dropdown me-2 me-lg-4 d-none d-lg-block">
                            ...
                            <ul className="dropdown-menu dropdown-menu-end mt-3">
                                <li><Link className="dropdown-item" to='/cheque-management/profile'>Profile</Link></li>
                ...
                <div className="offcanvas-body">
                    <div className="sidebar d-flex flex-column px-1 w-100">
                        <ul className="nav nav-pills flex-column mb-auto gap-2">
                            ...
                            <li>
                                <NavLink to="/cheque-management/cheques" className="nav-link">
                                    <div className="sidebar-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="16" viewBox="0 0 15 16" fill="none">
                            ...
                            <li>
                                <NavLink to="/cheque-management/report" className="nav-link">
                                    <div className="sidebar-icon">
                            ...
                            <li>
                                <NavLink to="/cheque-management/profile" className="nav-link">
                                    <div className="sidebar-icon">
