...
// Routes
app.post('/api/v1/scan-checks', upload.single('image'), scanCheck);
app.post('/api/v1/scan-licenses', upload.single('image'), scanLicense);
app.post('/api/v1/upload-images', upload.single('image'), uploadImage);

app.post('/api/v1/scan-check', upload.single('image'), scanChecks);
app.post('/api/v1/scan-license', upload.single('image'), scanLicenses);
